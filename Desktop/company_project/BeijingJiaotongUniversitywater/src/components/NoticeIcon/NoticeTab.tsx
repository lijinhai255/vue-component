          ...
          <List.Item.Meta
            ...
            title={
              <div className='notice__item-title'>
                ...
                {item.extra && (
                  <Typography.Text
                    className='notice__item-extra'
                    type={item.extra.level}
                  >
                    {item.extra.text}
                  </Typography.Text>
                )}
          ...
          >
            ...
            {notice.list.length > 0 && (
              <div className='navbar__notice__footer'>
                <div
                  className='navbar__notice__footer-title'
                  onClick={() => onClear(notice.key)}
                >
                  清空{notice.title}
                </div>
                <div
                  className='navbar__notice__footer-title'
                  onClick={() => onMore(notice.key)}
                >
                  查看更多
                </div>
              </div>
